...
<div class="login">
	<h1 class="STYLE1">Register Form</h1>
	<form  action="accountinfo.php" method="post">
		<input type="text" name="staffid" placeholder="StaffID" required="required" class="STYLE1"/>
		
		<input type="submit" class="btn btn-primary btn-block btn-large STYLE1" value="Register">
	</form>
</div>
<div class="mWrapper">
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="logo">
              <a  href="#"><img src="public/images/logo.png" alt="TAS"></a>
            </div>
          </div>
