...
//echo"this is the page for the head of education institue to change status for staff";
$id=$_GET['StaffID'];
setcookie('staffidcookie',$id);
...
<div class="mWrapper">
          ...
          <div class="col-sm-8 col-md-8">
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a href="headhome.php">Edit</a></li>
    ...
    <h1 align="center" class="font2"><strong>Edit Status</strong></h1>
    <br>
   <form action="processsta.php" method="post">
...
<td><input type="number" name="changesta" required="required" value="<?php echo $row['status'];?>"></td>
</tr>
