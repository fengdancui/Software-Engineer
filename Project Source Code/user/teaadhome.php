...
//echo "this is the page for teaching administrator to distribute account";
...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Unit Information</strong></h1>
    <br>
   <form>
...
echo "<td width='20px' height='10px'><a href='editunit.php?id={$row['id']}'><img alt='edit account' src='../public/images/editsta.png' width='20px' height='10px' ></a></td>";
echo "<td width='20px' height='10px'><a href='deleteunit.php?id={$row['id']}'><img alt='delete account' src='../public/images/delete.png' width='20px' height='10px' ></a></td>";
?>
</tr>
<?php
$i++;
