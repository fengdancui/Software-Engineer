...
<div class="mWrapper">
   ...
   <form action="updateaccount.php" method="post">
    ...
    <th style="text-align:center">Status (1=Active, 2=Suspended, 3=Terminated)</th>
    <th style="text-align:center">Role (1=Staff, 2=Teaching, <br>3=System Administrator, 4=Head of institute)</th>
    </tr>

<tr>
<td><?php echo $row['staffid'];?></td>
<td><input type="text" name="un" required="required" value="<?php echo $row['username'];?>"></td>
<td><input type="text" name="pass" required="required" value="<?php echo $row['password'];?>"></td>
<td><input type="number" name="sta" required="required" value="<?php echo $row['status'];?>"></td>
<td><input type="number" name="ro" required="required" value="<?php echo $row['role'];?>"></td>
</tr>
