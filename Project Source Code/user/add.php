...
//echo"this is the page for the system administrator to add an account";
?>
<!DOCTYPE html>
<html >
<head>
...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Add Account</strong></h1>
    <br>
...
<td><input type="number" name="sta" required="required"></td>
<td><input type="number" name="ro" required="required"></td>
</tr>
