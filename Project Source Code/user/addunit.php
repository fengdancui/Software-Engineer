...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Add Unit</strong></h1>
    <br>
   <form action="addunitcheck.php" method="post">
...
<td><input type="number" name="credit" required="required" "></td>
<td><input type="number" name="tri" required="required" ></td>
</tr>
