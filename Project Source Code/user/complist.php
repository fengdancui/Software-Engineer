...
$sql="SELECT staffid, username FROM `account` WHERE status=1 AND role=1 ";
$query=$dbh->query($sql);
...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Completed List</strong></h1>
    <br>
   <form action="updatepre.php" method="post">
    <table class="font" border="1" align="center" width="300">
   <tr align="center">
    <th style="text-align:center;">StaffID</th>
    <th style="text-align:center;">Username</th></tr>
    <?php 
    for ($i=0;$i<$col;$i++){
        $rowname=$row[$i];
        ?>
        <tr align="center"><td><?php echo $rowname[0];?></td>
        <td><?php echo $rowname[1];?></td></tr>
        <?php     
    }
    ?>
   </table>
