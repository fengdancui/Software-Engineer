...
<title>Account Status Information</title>
...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Account Status Information</strong></h1>
    <br>
   <form action="changesta.php" method="post">
...
echo "<td width='20' height='10'><a href='changesta.php?StaffID={$row['staffid']}'><img alt='edit status' src='../public/images/editsta.png' ></a></td>";
?>
</tr>
<?php
$i++;
