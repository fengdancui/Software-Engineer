<?php
//echo "this page is for change allocation";
include '../public/common/config.php';
$staffid=$_GET['staffid'];
$unit=$_GET['unit'];
$trimester=$_GET['trimester'];
setcookie("idcookie", $staffid);
setcookie("uncookie", $unit);
setcookie("tricookie", $trimester);
$sql="select * from allocated where staffid={$staffid} and unit='$unit' and trimester={$trimester}";
$query=$dbh->query($sql);
...
<div class="mWrapper">
    ...
    <h1 align="center" class="font2"><strong>Allocate Edit</strong></h1>
    <br>
   <form action="updateallocate.php" method="post">
...
<td><input type="number" name="uc" required="required" value="<?php echo $row['unitchair'];?>"></td>
</tr></table>
<br>
