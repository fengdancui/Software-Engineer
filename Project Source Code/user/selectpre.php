...
//echo "this is the page for staff to select preference";
...
<div class="mWrapper">
    ...
    <br>
   <form action="checkpre.php" method="post">
...
<td align="center"><input  type="number" name="preference[]" required="required"></td>
<td align="center"><input  type="number" name="are[]" required="required"></td>
<td align="center"><input  type="number" name="have[]" required="required"></td>
</tr>
<?php
$i++;
}
