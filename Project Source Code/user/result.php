...
//echo "this page is for checking allocation result";
$username=$_COOKIE['mycookie'];
$sql="select * from allocated where username='$username'";
$query=$dbh->query($sql);
if(!$query){
    echo "<script>alert('The result has not been published')</script>";
...
<br>
<div style="text-align:center;"><a onclick="isOk()" class="btn btn-primary btn-large" >Print</a></div>
<script>
function isOk(){
