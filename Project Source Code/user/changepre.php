...
//echo "this is the page for staff to change preference";
$un = $_COOKIE['mycookie'];
$unit=$_GET['unit'];
$trimester=$_GET['trimester'];
setcookie('cookieunit',$unit);
setcookie('cookietrimester',$trimester);
$sql="select * from $un where unit='$unit' and trimester=$trimester";
$query = $dbh->query($sql);
?>
<!DOCTYPE html>
<html >
...
<div class="mWrapper">
          ...
          <div class="col-sm-8 col-md-8">
            <nav class="mainMenu">
              <ul class="nav">
                ...
                <li><a href="changepre.php">Change</a></li>
    ...
    <br>
   <form action="updatepre.php" method="post">
    ...
    <th>Have you taught before?(1=Yes and 2=No)</th></tr>
...
<td align="center"><input  type="number" name="preference" required="required" value="<?php echo $row['preference'];?>"></td>
<td align="center"><input  type="number" name="are" required="required" value="<?php echo $row['are'];?>"></td>
<td align="center"><input  type="number" name="have" required="required" value="<?php echo $row['have'];?>"></td>
</tr>
<?php
$i++;
}
...
<input type="submit" class="btn btn-primary btn-large btn-al" value="submit">
  ...
  <input type="reset" class="btn btn-primary btn-large btn-al" value="reset"></form>
