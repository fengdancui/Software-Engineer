...
<body background="public/images/slider/img_1_blank.jpg">

<div class="login">
	<h1 class="STYLE1">Login Form</h1>
	<form action="check.php" method="post">
		<input type="text" name="username" placeholder="Username" required="required" class="STYLE1"/>
		<input type="password" name="password" placeholder="Password" required="required" class="STYLE1"/>
		<input type="submit" class="btn btn-primary btn-block btn-large STYLE1" value="login">
	</form>
</div>
<div class="mWrapper">
      <div class="container">
